...
#include "multimedia/video/mvideoframe.h"
#include "multimedia/video/mvideoframe_p.h"
#include "multimedia/video/qimagevideobuffer_p.h"
#include "multimedia/video/qmemoryvideobuffer_p.h"
#include "multimedia/video/qvideoframeconversionhelper_p.h"
...
{
    qRegisterMetaType<MVideoFrame>();
    qRegisterMetaType<MVideoFrame::FieldType>();
    qRegisterMetaType<MVideoFrame::PixelFormat>();
}

Q_CONSTRUCTOR_FUNCTION(qRegisterVideoFrameMetaTypes)


class MVideoFramePrivate : public QSharedData
{
public:
    MVideoFramePrivate()
        : startTime(-1)
        ...
        , mappedBytes(0)
        , planeCount(0)
        , pixelFormat(MVideoFrame::Format_Invalid)
        , fieldType(MVideoFrame::ProgressiveFrame)
        , buffer(nullptr)
        , mappedCount(0)
    {
    ...
    MVideoFramePrivate(const QSize &size, MVideoFrame::PixelFormat format)
        : size(size)
        , startTime(-1)
        , endTime(-1)
        , mappedBytes(0)
    ...
    int mappedBytes;
    int planeCount;
    MVideoFrame::PixelFormat pixelFormat;
    MVideoFrame::FieldType fieldType;
...
private:
    Q_DISABLE_COPY(MVideoFramePrivate)
};

/*!
    \class MVideoFrame
    \brief The MVideoFrame class represents a frame of video data.
    \inmodule QtMultimedia

    \ingroup multimedia
    \ingroup multimedia_video

    A MVideoFrame encapsulates the pixel data of a video frame, and information about the frame.
    ...
    The video pixel data in a MVideoFrame is encapsulated in a QAbstractVideoBuffer.  A QVideoFrame
    may be constructed from any buffer type by subclassing the QAbstractVideoBuffer class.

    \note Since video frames can be expensive to copy, MVideoFrame is explicitly shared, so any
    change made to a video frame will also apply to any copies.
*/

/*!
    \enum MVideoFrame::PixelFormat
...
*/
MVideoFrame::MVideoFrame()
    : d(new MVideoFramePrivate)
{
}
...
MVideoFrame::MVideoFrame(
    ...
    : d(new MVideoFramePrivate(size, format))
{
    d->buffer = buffer;
}
...
*/
MVideoFrame::MVideoFrame(int bytes, const QSize &size, int bytesPerLine, PixelFormat format)
    : d(new MVideoFramePrivate(size, format))
{
    if (bytes > 0) {
        QByteArray data;
...
*/
MVideoFrame::MVideoFrame(const QImage &image)
    : d(new MVideoFramePrivate(
...
/*!
    Constructs a shallow copy of \a other.  Since MVideoFrame is
    explicitly shared, these two instances will reflect the same frame.

*/
MVideoFrame::MVideoFrame(const MVideoFrame &other)
    : d(other.d)
{
}

/*!
    Assigns the contents of \a other to this video frame.  Since MVideoFrame is
    explicitly shared, these two instances will reflect the same frame.

*/
MVideoFrame &MVideoFrame::operator =(const MVideoFrame &other)
{
    d = other.d;
...
/*!
  \return \c true if this MVideoFrame and \a other reflect the same frame.
 */
bool MVideoFrame::operator==(const MVideoFrame &other) const
{
...
/*!
  \return \c true if this MVideoFrame and \a other do not reflect the same frame.
 */
bool MVideoFrame::operator!=(const MVideoFrame &other) const
{
    return d != other.d;
...
/*!
    ...
    \since 5.13
*/
QAbstractVideoBuffer *MVideoFrame::buffer() const
{
    return d->buffer;
}
...
*/
bool MVideoFrame::isValid() const
{
...
*/
MVideoFrame::PixelFormat MVideoFrame::pixelFormat() const
{
...
*/
QAbstractVideoBuffer::HandleType MVideoFrame::handleType() const
{
...
*/
MVideoFrame::FieldType MVideoFrame::fieldType() const
{
    return d->fieldType;
}
...
*/
void MVideoFrame::setFieldType(MVideoFrame::FieldType field)
{
    d->fieldType = field;
}
...
bool MVideoFrame::isMapped() const
{
...
/*!
    ...
    \sa mapMode(), QAbstractVideoBuffer::MapMode
*/
bool MVideoFrame::isWritable() const
{
...
/*!
    ...
    \sa mapMode(), QAbstractVideoBuffer::MapMode
*/
bool MVideoFrame::isReadable() const
{
...
*/
QAbstractVideoBuffer::MapMode MVideoFrame::mapMode() const
{
    return d->buffer != nullptr ? d->buffer->mapMode() : QAbstractVideoBuffer::NotMapped;
}
...
*/
bool MVideoFrame::map(QAbstractVideoBuffer::MapMode mode)
{
...
void MVideoFrame::unmap()
{
    ...
    if (d->mappedCount == 0) {
        qWarning() << "MVideoFrame::unmap() was called more times then MVideoFrame::map()";
        return;
    }
...
/*!
    ...
    planes should be calculated as per the frame \l{MVideoFrame::PixelFormat}{pixel format}.

    This value is only valid while the frame data is \l {map()}{mapped}.

    \sa bits(), map(), mappedBytes()
*/
int MVideoFrame::bytesPerLine() const
{
...
int MVideoFrame::bytesPerLine(int plane) const
{
...
/*!
    ...
    \since 5.4
*/
uchar *MVideoFrame::bits(int plane)
{
...
/*!
    ...
    \sa map(), mappedBytes(), bytesPerLine()
*/
const uchar *MVideoFrame::bits() const
{
    return d->data[0];
}
...
/*!
    ...
    \since 5.4
*/
const uchar *MVideoFrame::bits(int plane) const
{
    return plane >= 0 && plane < d->planeCount ?  d->data[plane] : nullptr;
}
...
/*!
    ...
    \sa map()
*/
int MVideoFrame::mappedBytes() const
{
...
int MVideoFrame::planeCount() const
{
    return d->planeCount;
}
...
*/
QVariant MVideoFrame::handle() const
{
...
*/
qint64 MVideoFrame::startTime() const
{
    return d->startTime;
}
...
*/
void MVideoFrame::setStartTime(qint64 time)
{
    d->startTime = time;
}
...
*/
qint64 MVideoFrame::endTime() const
{
    return d->endTime;
}
...
*/
void MVideoFrame::setEndTime(qint64 time)
{
    d->endTime = time;
}
 ...
 */
QVariantMap MVideoFrame::availableMetaData() const
{
    return d->metadata;
}
 ...
 */
QVariant MVideoFrame::metaData(const QString &key) const
{
 ...
 */
void MVideoFrame::setMetaData(const QString &key, const QVariant &value)
{
    if (!value.isNull())
...
/*!
    ...
    format MVideoFrame::InvalidType is returned instead.

    \note In general \l QImage does not handle YUV formats.

*/
MVideoFrame::PixelFormat MVideoFrame::pixelFormatFromImageFormat(QImage::Format format)
{
    switch (format) {
...
*/
QImage::Format MVideoFrame::imageFormatFromPixelFormat(PixelFormat format)
{
    switch (format) {
    case Format_Invalid:
...
extern void QT_FASTCALL qt_convert_BGRA32_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_BGR24_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_BGR565_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_BGR555_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_AYUV444_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_YUV444_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_YUV420P_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_YV12_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_UYVY_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_YUYV_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_NV12_to_ARGB32(const MVideoFrame&, uchar*);
extern void QT_FASTCALL qt_convert_NV21_to_ARGB32(const MVideoFrame&, uchar*);

static VideoFrameConvertFunc qConvertFuncs[MVideoFrame::NPixelFormats] = {
...
static void qInitConvertFuncsAsm()
{
    ...
    extern void QT_FASTCALL qt_convert_BGRA32_to_ARGB32_sse2(const MVideoFrame&, uchar*);
    if (qCpuHasFeature(SSE2)){
        qConvertFuncs[MVideoFrame::Format_BGRA32] = qt_convert_BGRA32_to_ARGB32_sse2;
        qConvertFuncs[MVideoFrame::Format_BGRA32_Premultiplied] = qt_convert_BGRA32_to_ARGB32_sse2;
        qConvertFuncs[MVideoFrame::Format_BGR32] = qt_convert_BGRA32_to_ARGB32_sse2;
    }
#endif
#ifdef QT_COMPILER_SUPPORTS_SSSE3
    extern void QT_FASTCALL qt_convert_BGRA32_to_ARGB32_ssse3(const MVideoFrame&, uchar*);
    if (qCpuHasFeature(SSSE3)){
        qConvertFuncs[MVideoFrame::Format_BGRA32] = qt_convert_BGRA32_to_ARGB32_ssse3;
        qConvertFuncs[MVideoFrame::Format_BGRA32_Premultiplied] = qt_convert_BGRA32_to_ARGB32_ssse3;
        qConvertFuncs[MVideoFrame::Format_BGR32] = qt_convert_BGRA32_to_ARGB32_ssse3;
    }
#endif
#ifdef QT_COMPILER_SUPPORTS_AVX2
    extern void QT_FASTCALL qt_convert_BGRA32_to_ARGB32_avx2(const MVideoFrame&, uchar*);
    if (qCpuHasFeature(AVX2)){
        qConvertFuncs[MVideoFrame::Format_BGRA32] = qt_convert_BGRA32_to_ARGB32_avx2;
        qConvertFuncs[MVideoFrame::Format_BGRA32_Premultiplied] = qt_convert_BGRA32_to_ARGB32_avx2;
        qConvertFuncs[MVideoFrame::Format_BGR32] = qt_convert_BGRA32_to_ARGB32_avx2;
    }
#endif
}
...
/*!
    \internal
*/
QImage qt_imageFromVideoFrame(const MVideoFrame &f)
{
    MVideoFrame &frame = const_cast<MVideoFrame&>(f);
    QImage result;
    ...
    QImage::Format imageFormat = MVideoFrame::imageFormatFromPixelFormat(frame.pixelFormat());
    if (imageFormat != QImage::Format_Invalid) {
        result = QImage(frame.bits(), frame.width(), frame.height(), frame.bytesPerLine(), imageFormat).copy();
    }

    // Load from JPG
    else if (frame.pixelFormat() == MVideoFrame::Format_Jpeg) {
...
QDebug operator<<(QDebug dbg, MVideoFrame::PixelFormat pf)
{
    QDebugStateSaver saver(dbg);
    dbg.nospace();
    switch (pf) {
        case MVideoFrame::Format_Invalid:
            return dbg << "Format_Invalid";
        case MVideoFrame::Format_ARGB32:
            return dbg << "Format_ARGB32";
        case MVideoFrame::Format_ARGB32_Premultiplied:
            return dbg << "Format_ARGB32_Premultiplied";
        case MVideoFrame::Format_RGB32:
            return dbg << "Format_RGB32";
        case MVideoFrame::Format_RGB24:
            return dbg << "Format_RGB24";
        case MVideoFrame::Format_RGB565:
            return dbg << "Format_RGB565";
        case MVideoFrame::Format_RGB555:
            return dbg << "Format_RGB555";
        case MVideoFrame::Format_ARGB8565_Premultiplied:
            return dbg << "Format_ARGB8565_Premultiplied";
        case MVideoFrame::Format_BGRA32:
            return dbg << "Format_BGRA32";
        case MVideoFrame::Format_BGRA32_Premultiplied:
            return dbg << "Format_BGRA32_Premultiplied";
        case MVideoFrame::Format_ABGR32:
            return dbg << "Format_ABGR32";
        case MVideoFrame::Format_BGR32:
            return dbg << "Format_BGR32";
        case MVideoFrame::Format_BGR24:
            return dbg << "Format_BGR24";
        case MVideoFrame::Format_BGR565:
            return dbg << "Format_BGR565";
        case MVideoFrame::Format_BGR555:
            return dbg << "Format_BGR555";
        case MVideoFrame::Format_BGRA5658_Premultiplied:
            return dbg << "Format_BGRA5658_Premultiplied";
        case MVideoFrame::Format_AYUV444:
            return dbg << "Format_AYUV444";
        case MVideoFrame::Format_AYUV444_Premultiplied:
            return dbg << "Format_AYUV444_Premultiplied";
        case MVideoFrame::Format_YUV444:
            return dbg << "Format_YUV444";
        case MVideoFrame::Format_YUV420P:
            return dbg << "Format_YUV420P";
        case MVideoFrame::Format_YUV422P:
            return dbg << "Format_YUV422P";
        case MVideoFrame::Format_YV12:
            return dbg << "Format_YV12";
        case MVideoFrame::Format_UYVY:
            return dbg << "Format_UYVY";
        case MVideoFrame::Format_YUYV:
            return dbg << "Format_YUYV";
        case MVideoFrame::Format_NV12:
            return dbg << "Format_NV12";
        case MVideoFrame::Format_NV21:
            return dbg << "Format_NV21";
        case MVideoFrame::Format_IMC1:
            return dbg << "Format_IMC1";
        case MVideoFrame::Format_IMC2:
            return dbg << "Format_IMC2";
        case MVideoFrame::Format_IMC3:
            return dbg << "Format_IMC3";
        case MVideoFrame::Format_IMC4:
            return dbg << "Format_IMC4";
        case MVideoFrame::Format_Y8:
            return dbg << "Format_Y8";
        case MVideoFrame::Format_Y16:
            return dbg << "Format_Y16";
        case MVideoFrame::Format_Jpeg:
            return dbg << "Format_Jpeg";
        case MVideoFrame::Format_AdobeDng:
            return dbg << "Format_AdobeDng";
        case MVideoFrame::Format_CameraRaw:
...
QDebug operator<<(QDebug dbg, MVideoFrame::FieldType f)
{
    QDebugStateSaver saver(dbg);
    dbg.nospace();
    switch (f) {
        case MVideoFrame::TopField:
            return dbg << "TopField";
        case MVideoFrame::BottomField:
            return dbg << "BottomField";
        case MVideoFrame::InterlacedFrame:
...
QDebug operator<<(QDebug dbg, const MVideoFrame& f)
{
    QDebugStateSaver saver(dbg);
    dbg.nospace();
    dbg << "MVideoFrame(" << f.size() << ", "
               << f.pixelFormat() << ", "
               << f.handleType() << ", "
               << f.mapMode() << ", "
