...
public:
    ...
    QVideoSurfaceFormatPrivate(
            const QSize &size,
            MVideoFrame::PixelFormat format,
...
*/
QVideoSurfaceFormat::QVideoSurfaceFormat(
        const QSize& size, MVideoFrame::PixelFormat format, QAbstractVideoBuffer::HandleType type)
...
{
    return d->pixelFormat != MVideoFrame::Format_Invalid && d->frameSize.isValid();
}
...
*/
MVideoFrame::PixelFormat QVideoSurfaceFormat::pixelFormat() const
{
