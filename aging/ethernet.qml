...
//            console.log(mptext);
        ...
        Settings{
            id: settings
            property var ethcommand: "ping -I eth0 www.baidu.com"
        }
...
//                                  textEdit.forceActiveFocus();
    ...
    Component.onCompleted: {
        var cmd = settings.value("ethcommand", "ping -I eth0 www.baidu.com")
        console.log("startProcess in ethernet.qml: ", cmd);
//            if(visible === true){
