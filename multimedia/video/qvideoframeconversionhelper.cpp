...
void QT_FASTCALL qt_convert_YUV420P_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
...
void QT_FASTCALL qt_convert_YV12_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_TRIPLANAR(frame)
    planarYUV420_to_ARGB32(plane1, plane1Stride,
                           plane3, plane3Stride,
...
void QT_FASTCALL qt_convert_AYUV444_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
...
void QT_FASTCALL qt_convert_YUV444_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
...
void QT_FASTCALL qt_convert_UYVY_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
...
void QT_FASTCALL qt_convert_YUYV_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
    MERGE_LOOPS(width, height, stride, 2)
...
void QT_FASTCALL qt_convert_NV12_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
...
void QT_FASTCALL qt_convert_NV21_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_BIPLANAR(frame)
    planarYUV420_to_ARGB32(plane1, plane1Stride,
                           plane2 + 1, plane2Stride,
...
void QT_FASTCALL qt_convert_BGRA32_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
    MERGE_LOOPS(width, height, stride, 4)
...
void QT_FASTCALL qt_convert_BGR24_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
    MERGE_LOOPS(width, height, stride, 3)
...
void QT_FASTCALL qt_convert_BGR565_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
    MERGE_LOOPS(width, height, stride, 2)
...
void QT_FASTCALL qt_convert_BGR555_to_ARGB32(const MVideoFrame &frame, uchar *output)
{
    FETCH_INFO_PACKED(frame)
    MERGE_LOOPS(width, height, stride, 2)
